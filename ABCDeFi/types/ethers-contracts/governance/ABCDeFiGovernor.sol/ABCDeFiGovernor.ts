...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface ABCDeFiGovernorInterface extends Interface {
    getFunction(nameOrSignature: "DEFAULT_ADMIN_ROLE" | "abcdToken" | "castVote" | "createProposal" | "executeProposal" | "getRoleAdmin" | "grantRole" | "hasRole" | "hasVoted" | "proposals" | "renounceRole" | "revokeRole" | "supportsInterface" | "totalProposals"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "ProposalCreated" | "ProposalExecuted" | "RoleAdminChanged" | "RoleGranted" | "RoleRevoked" | "VoteCast"): EventFragment;
...
decodeFunctionResult(functionFragment: 'totalProposals', data: BytesLike): Result;
    ...
    export namespace ProposalCreatedEvent {
      export type InputTuple = [proposalId: BigNumberish, proposer: AddressLike, title: string, startTime: BigNumberish, endTime: BigNumberish];
      export type OutputTuple = [proposalId: bigint, proposer: string, title: string, startTime: bigint, endTime: bigint];
      export interface OutputObject {proposalId: bigint, proposer: string, title: string, startTime: bigint, endTime: bigint };
  ...
  export interface ABCDeFiGovernor extends BaseContract {
    
    connect(runner?: ContractRunner | null): ABCDeFiGovernor;
    waitForDeployment(): Promise<this>;

    interface: ABCDeFiGovernorInterface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    createProposal: TypedContractMethod<
      [title: string, description: string, votingDurationSeconds: BigNumberish, ],
      [bigint],
      'nonpayable'
    >
    ...
    proposals: TypedContractMethod<
      [arg0: BigNumberish, ],
      [[bigint, string, string, string, bigint, bigint, bigint, bigint, boolean] & {proposalId: bigint, proposer: string, title: string, description: string, forVotes: bigint, againstVotes: bigint, startTime: bigint, endTime: bigint, executed: boolean }],
      'view'
    >
