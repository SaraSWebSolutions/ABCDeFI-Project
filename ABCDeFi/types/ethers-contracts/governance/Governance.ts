...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface GovernanceInterface extends Interface {
    getFunction(nameOrSignature: "DEFAULT_ADMIN_ROLE" | "createProposal" | "executeProposal" | "getRoleAdmin" | "grantRole" | "hasRole" | "hasVoted" | "proposals" | "renounceRole" | "revokeRole" | "supportsInterface" | "totalProposals" | "treasuryVote" | "vote"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "ProposalCreated" | "ProposalExecuted" | "RoleAdminChanged" | "RoleGranted" | "RoleRevoked" | "TreasuryVoteExecuted" | "VoteCast"): EventFragment;

    encodeFunctionData(functionFragment: 'DEFAULT_ADMIN_ROLE', values?: undefined): string;
encodeFunctionData(functionFragment: 'createProposal', values: [string, string, BigNumberish, BigNumberish]): string;
...
encodeFunctionData(functionFragment: 'treasuryVote', values: [BigNumberish, BigNumberish]): string;
...
decodeFunctionResult(functionFragment: 'treasuryVote', data: BytesLike): Result;
decodeFunctionResult(functionFragment: 'vote', data: BytesLike): Result;
  }

  
    export namespace ProposalCreatedEvent {
      export type InputTuple = [proposalId: BigNumberish, proposer: AddressLike, category: BigNumberish, title: string];
      export type OutputTuple = [proposalId: bigint, proposer: string, category: bigint, title: string];
      export interface OutputObject {proposalId: bigint, proposer: string, category: bigint, title: string };
    ...
    export namespace TreasuryVoteExecutedEvent {
      export type InputTuple = [proposalId: BigNumberish, amountAllocated: BigNumberish];
      export type OutputTuple = [proposalId: bigint, amountAllocated: bigint];
      export interface OutputObject {proposalId: bigint, amountAllocated: bigint };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    createProposal: TypedContractMethod<
      [title: string, description: string, category: BigNumberish, durationSeconds: BigNumberish, ],
      [bigint],
      'nonpayable'
    >
    ...
    proposals: TypedContractMethod<
      [arg0: BigNumberish, ],
      [[bigint, string, bigint, string, string, bigint, bigint, bigint, bigint, boolean] & {proposalId: bigint, proposer: string, category: bigint, title: string, description: string, forVotes: bigint, againstVotes: bigint, startTime: bigint, endTime: bigint, executed: boolean }],
      'view'
    >
    ...
    treasuryVote: TypedContractMethod<
      [proposalId: BigNumberish, amountAllocated: BigNumberish, ],
      [void],
      'nonpayable'
    >
...
getFunction(nameOrSignature: 'totalProposals'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'treasuryVote'): TypedContractMethod<
      [proposalId: BigNumberish, amountAllocated: BigNumberish, ],
      [void],
      'nonpayable'
    >;
...
getEvent(key: 'TreasuryVoteExecuted'): TypedContractEvent<TreasuryVoteExecutedEvent.InputTuple, TreasuryVoteExecutedEvent.OutputTuple, TreasuryVoteExecutedEvent.OutputObject>;
getEvent(key: 'VoteCast'): TypedContractEvent<VoteCastEvent.InputTuple, VoteCastEvent.OutputTuple, VoteCastEvent.OutputObject>;

    filters: {
      
      'ProposalCreated(uint256,address,uint8,string)': TypedContractEvent<ProposalCreatedEvent.InputTuple, ProposalCreatedEvent.OutputTuple, ProposalCreatedEvent.OutputObject>;
      ...
      'TreasuryVoteExecuted(uint256,uint256)': TypedContractEvent<TreasuryVoteExecutedEvent.InputTuple, TreasuryVoteExecutedEvent.OutputTuple, TreasuryVoteExecutedEvent.OutputObject>;
      TreasuryVoteExecuted: TypedContractEvent<TreasuryVoteExecutedEvent.InputTuple, TreasuryVoteExecutedEvent.OutputTuple, TreasuryVoteExecutedEvent.OutputObject>;
