...
encodeFunctionData(functionFragment: 'marketplaceFeeBps', values?: undefined): string;
...
decodeFunctionResult(functionFragment: 'marketplaceFeeBps', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'updateListingPrice', data: BytesLike): Result;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    marketplaceFeeBps: TypedContractMethod<
      [],
      [bigint],
      'view'
    >
...
getFunction(nameOrSignature: 'listNFT'): TypedContractMethod<
      ...
      'nonpayable'
    >;
getFunction(nameOrSignature: 'marketplaceFeeBps'): TypedContractMethod<
      [],
      [bigint],
      'view'
    >;
