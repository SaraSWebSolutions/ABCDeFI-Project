...
decodeFunctionResult(functionFragment: 'unpause', data: BytesLike): Result;
  ...
  export interface OracleAdapterV2 extends BaseContract {
    
    connect(runner?: ContractRunner | null): OracleAdapterV2;
    waitForDeployment(): Promise<this>;

    interface: OracleAdapterV2Interface;
...
getFunction(nameOrSignature: 'paused'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'priceUSD'): TypedContractMethod<
      [asset: AddressLike, ],
      [bigint],
      'view'
    >;
