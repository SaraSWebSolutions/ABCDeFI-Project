...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IERC20BurnableTokenInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'mint', data: BytesLike): Result;
  ...
  export interface IERC20BurnableToken extends BaseContract {
    
    connect(runner?: ContractRunner | null): IERC20BurnableToken;
    waitForDeployment(): Promise<this>;

    interface: IERC20BurnableTokenInterface;
