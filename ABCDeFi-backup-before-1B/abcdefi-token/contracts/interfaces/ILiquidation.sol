...
interface ILiquidation {
    ...
    // --- View Functions ---
    function calculateHealthFactor(address borrower) external view returns (uint256 healthFactor);
    function calculateHealthFactorFromValues(uint256 collateralETH, uint256 debtTokens) external view returns (uint256 healthFactor);
