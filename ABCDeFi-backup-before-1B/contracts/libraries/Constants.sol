...
library Constants {
    ...
    // Supply Constants
    uint256 public constant MAX_SUPPLY = 1_000_000_000_000_000 * 10**18; // ABCDeFi whitepaper: 1,000,000,000,000,000 ABCD (1 Quadrillion)

    // Basis Points (Total = 10,000 BPS = 100%)
    uint256 public constant BPS_DENOMINATOR = 10_000;

    uint256 public constant FOUNDER_BPS     = 5500; // 55%  (550,000,000,000,000 ABCD)
    uint256 public constant ICO_BPS         = 2000; // 20%  (200,000,000,000,000 ABCD)
    uint256 public constant MARKETING_BPS   = 1000; // 10%  (100,000,000,000,000 ABCD)
    uint256 public constant FINANCE_BPS     = 900;  // 9%   (90,000,000,000,000 ABCD)
    uint256 public constant ADVISOR_BPS     = 200;  // 2%   (20,000,000,000,000 ABCD)
    uint256 public constant RESERVE_BPS     = 200;  // 2%   (20,000,000,000,000 ABCD)
    uint256 public constant CONTINGENCY_BPS = 200;  // 2%   (20,000,000,000,000 ABCD)
